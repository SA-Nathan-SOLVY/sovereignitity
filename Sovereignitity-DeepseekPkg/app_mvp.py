...
@app.route('/api/tax/optimize-expenses', methods=['POST'])
...
@app.route('/api/tax/quarterly-estimates', methods=['POST'])
...
if __name__ == '__main__':
    print("🚀 Starting SOVEREIGNITITY™ MVP API...")
    ...
    print("  - POST http://localhost:5001/api/tax/calculate")
    print("  - GET  http://localhost:5001/api/solvy/dashboard")
